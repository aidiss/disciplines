...
pure=True, hard=True, life=True	
#pure hard life
['Biology', 'Biochemistry', 'Genetics', 'Physiology'.

pure=True, hard=True, life=False	
#nolife
['Mathematics', 'Physics', 'Chemistry', 'Geology', 'Astronomy', 'Oceanography']
#soft#life
['Psychology', 'Sociology', 'Anthropology', 'Political Science', 'Area Study']
#nolife
['Linguistics', 'Literature', 'Communications', 'Creative Writing', 'Economics', 'Philosophy', 'Archaeology', 'History', 'Geography']
pure=False, hard=True, life=True	
#applied hard #life
['Agriculture', 'Psychiatry', 'Medicine', 'Pharmacy', 'Dentistry', 'Horticulture']
#nolife
['Civil Engineering', 'Telecommunication Engineering', 'Mechanical Engineering', 'Chemical Engineering', 'Electrical Engineering', 'Computer Science']
#life
['Recreation', 'Arts', 'Education', 'Nursing', 'Conservation', 'Counseling', 'HR Management']
#nolife
['Finance', 'Accounting', 'Banking', 'Marketing', 'Journalism', 'Library And Archival Science', 'Law', 'Architecture', 'Interior Design', 'Crafts', 'Arts', 'Dance', 'Music']
