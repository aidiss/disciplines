...
article = {
    ...
    'figures': {
        1: {
            'source': 'Continuum of academic knowledge (after Coffin et al., 2003)',
    ...
    'tables': {
        1: {
            'name': 'Table 2 Rank order of citations by discipline per 1,000 words'
...
# This table is shortened version of As_can_be_seen.py
