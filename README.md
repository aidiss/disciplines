...
It should use sociological, historical, economical approaches.
- Getting theories about disciplines. Such as *Academic tribes and territories* by Becher, or number of approaches listed in *The sociology of scientific work* by Vinck, or stages of emergence by Ziman.
- Getting data about disciplines, related conferences, publications, descriptions, syllabuses, pictures, people and other related objects.
- Applying theories to data. With having formal approach to theories and different data we can do amazing things.
- Visualise it - creates different visualization. 
- Natural-language-description generator - describes the findings in natural text.
- Export it to web, word, latex and etc. To keep people informed about findings.
...
- text_analysis - this part uses nltk and other packages to do analysis looking for some disciplinary aspects on text.
- disc_crawler - miner that looks for disciplinary aspects on web.
- theories - programic description of various theories that describe how disciplines are, develop, how they should be cattegorasied. [Vinck]

> The main goal is to have a system of tools that would be useful seperately but the most powerful in one set.
